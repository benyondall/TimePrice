...
/**
 * Created by liuwan on 2017/7/23.
 * 自定义时间控件
 */
public class CustomDatePicker {
    ...
    private static final int MAX_MINUTE = 59;/*设置最大的分钟值*/
    private static final int MAX_HOUR = 23;/*设置最大的小时值*/
    private static final int MIN_MINUTE = 0;/*设置最小的分钟值*/
    private static final int MIN_HOUR = 0;/*设置最小的小时值*/
    private static final int MAX_MONTH = 12;/*设置最大的月份值*/

    private ArrayList<String> year, month, day, hour, minute;
    private int startYear, startMonth, startDay, startHour, startMinute, endYear, endMonth, endDay, endHour, endMinute;
    private boolean spanYear, spanMon, spanDay, spanHour, spanMin;
    private Calendar selectedCalender, startCalendar, endCalendar;
    private TextView tv_cancle, tv_select, hour_text, minute_text,year_text,month_text,day_text;
    /*构造方法*/
